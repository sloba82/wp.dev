...
function ltheme_widgets_init() {
	register_sidebar(
		array(
			'name'          => __( 'Sidebar Right Blog', 'ltheme' ),
			'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		    'name'          => __( 'Sidebar left Blog', 'themename' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Sidebar Right Woocommerce', 'ltheme' ),
			'id'            => 'sidebar-right-ws',
			'description'   => __( 'Add widgets here to appear in your sidebar.', 'ltheme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
	...
	register_sidebar( array(
		    'name'          => __( 'Sidebar Left Woocommerce', 'themename' ),
		    'id'            => 'sidebar-left-ws',
		    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		    'after_widget'  => '</aside>',
		    'before_title'  => '<h3 class="widget-title">',
