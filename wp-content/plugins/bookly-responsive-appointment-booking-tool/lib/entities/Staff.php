...
class Staff extends Lib\Base\Entity
{
     ...
     * @return int
     */
    public function getZoomPersonal()
    {
        return $this->zoom_personal;
    }

    /**
     * Sets zoom_personal
     *
     * @param int $zoom_personal
     * @return $this
     */
    public function setZoomPersonal( $zoom_personal )
    {
        $this->zoom_personal = $zoom_personal;
    ...
    /**
     * Sets zoom_jwt_api_secret
     *
     * @param string $zoom_jwt_api_secret
     * @return $this
     */
    public function setZoomJwtApiSecret( $zoom_jwt_api_secret )
    {
        $this->zoom_jwt_api_secret = $zoom_jwt_api_secret;
